...
#Parameters
cor_lr = 0.05
cor_lr_delta = cor_lr * 0.01
incor_lr = 0.01
incor_lr_delta = incor_lr * 0.01
...
for epoch in range(0, num_epochs):
    ...
    for i, data in enumerate(trainloader):
        ...
        detailed_cor_lr_output.append(cor_lr)
        detailed_incor_lr_output.append(incor_lr)
